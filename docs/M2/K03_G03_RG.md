...
| Aktor | Deskripsi |
| :--- | :--- |
| *Pembuat tantangan* | *Pengguna ini bertindak sebagai pihak yang sudah menguasai Git dan mendesain capaian pembelajaran, permasalahan, dan aturan validasi. Karakteristik dari pengguna adalah mengutamakan ketelitian dalam mendesain tantangan.* |
