...
| :--- | :--- | :--- | :--- |
| *C01* | *Pengguna* | *Kelas induk/dasar untuk menyimpan informasi akun pengguna.* | *UC01, UC02, UC03, UC04* |
| *C02* | *PembuatTantangan* | *Subkelas dari Pengguna, bertugas untuk membuat, merilis tantangan, dan mengujinya.* | *UC01, UC02, UC04* |
| *C03* | *Pelajar* | *Subkelas dari Pengguna, dapat mengimpor tantangan, mengerjakan tantangan, dan melihat riwayat.* | *UC03, UC04* |
| *C04* | *Tantangan* | *Berisi informasi tentang tantangan, seperti judul, deskripsi, spesifikasi, dan setup script.* | *UC01, UC02, UC03* |
| *C05* | *RepositoriSimulasi* | *Merepresentasikan repositori Git yang akan dimanipulasi oleh Pelajar.* | *UC02, UC03* |
| *C06* | *SesiPengerjaan* | *Menampilkan status pengerjaan, menyediakan antarmuka terminal, memverifikasi hasil, dan mencatat skor Pelajar.* | *UC03, UC04* |
| *C07* | *RiwayatKonsol* | *Menyimpan catatan perintah yang diketikkan Pelajar selama sesi pengerjaan.* | *UC03, UC04* |
...
| :--- | :--- | :--- |
| *C02* | *PembuatTantangan* | *Pengguna yang mengembangkan tantangan baru.* | *UC01, UC02, UC04* |
| *C04* | *Tantangan* | *Menyimpan informasi judul, deskripsi, spesifikasi, dan setup script tantangan.* | *UC01, UC02, UC03* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/class-diagram-uc1.webp" width="70%">
</p>
<p align="center">
...
| :--- | :--- | :--- | :--- |
| *C02* | *PembuatTantangan* | *idPengguna, nama, email* | *buatTantangan(), kelolaTantangan()* |
| *C04* | *Tantangan* | *idTantangan, judul, deskripsi, setupScript, status* | *simpanTantangan(), hapusTantangan()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *PembuatTantangan* | *Pengguna yang menguji dan merilis tantangan baru.* | *UC01, UC02, UC04* |
| *C04* | *Tantangan* | *Tantangan yang sedang diuji atau dievaluasi.* | *UC01, UC02, UC03* |
| *C05* | *RepositoriSimulasi* | *Repositori Git untuk menguji setup script dan sistem verifikasi.* | *UC02, UC03* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC02" src="./assets/diagram/class-diagram-uc2.webp" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C02* | *PembuatTantangan* | *idPengguna, nama.* | *ujiTantangan(), rilisTantangan()* |
| *C04* | *Tantangan* | *idTantangan, setupScript* | *muatSetupScript()* |
| *C05* | *RepositoriSimulasi* | *idRepositori, statusRepositori* | *inisialisasiRepositori(), prosesCommand()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C03* | *Pelajar* | *Pengguna yang mengimpor dan mengerjakan tantangan.* | *UC03, UC04* |
| *C04* | *Tantangan* | *Tantangan yang sedang dikerjakan.* | *UC01, UC02, UC03* |
| *C05* | *RepositoriSimulasi* | *Repositori Git tempat pelajar mengeksekusi perintah CLI.* | *UC02, UC03* |
| *C06* | *SesiPengerjaan* | *Mencatat status pengerjaan, memverifikasi hasil, dan mencatat skor Pelajar.* | *UC03, UC04* |
| *C07* | *RiwayatKonsol* | *Menyimpan catatan perintah yang digunakan Pelajar selama sesi pengerjaan.* | *UC03, UC04* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC03" src="./assets/diagram/class-diagram-uc3.webp" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C03* | *Pelajar* | *idPengguna, nama* | *pilihTantangan(), kirimSolusi()* |
| *C04* | *Tantangan* | *idTantangan, aturanVerifikasi* | *verifikasiSolusi()* |
| *C05* | *RepositoriSimulasi* | *idRepositori, pathRepositori* | *jalankanCommand(), cekKondisi()* |
| *C06* | *SesiPengerjaan* | *idSesi, statusPengerjaan, skor* | *mulaiSesi(), kirimPekerjaan()* |
| *C07* | *RiwayatKonsol* | *idRiwayat, daftarPerintah.* | *catatPerintah(), tampilkanRiwayat()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *PembuatTantangan* | *Melihat rekap nilai dan laporan hasil pengerjaan.* | *UC01, UC02, UC04* |
| *C03* | *Pelajar* | *Melihat riwayat pengerjaan dan status kelulusan pribadi.* | *UC03, UC04* |
| *C06* | *SesiPengerjaan* | *Menyimpan riwayat percobaan dan hasil pengerjaan.* | *UC03, UC04* |
| *C07* | *RiwayatKonsol* | *Menampilkan perintah-perintah yang telah dieksekusi pada tiap sesi percobaan.* | *UC03, UC04* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC04" src="./assets/diagram/class-diagram-uc4.webp" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C02* | *PembuatTantangan* | *idPengguna, nama* | *lihatRekapitulasi()* |
| *C03* | *Pelajar* | *idPengguna, nama* | *lihatRiwayat()* |
| *C06* | *SesiPengerjaan* | *idSesi, skor* | *ambilRiwayat()* |
| *C07* | *RiwayatKonsol* | *idRiwayat, daftarPerintah* | *muatRiwayatKonsol()* |
