...
Batasan ruang lingkup aplikasinya adalah pembelajaran perintah dasar-menengah Git beserta utilitas POSIX secara interaktif melalui aplikasi. Batasan regulasi adalah kepatuhan terhadap lisensi open-source dan keamanan data privasi pengguna. Batasan dari segi sumber daya mencakup kapasitas komputasi server real-time dan waktu pengembangan yang terbatas.
